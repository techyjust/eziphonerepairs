...
base='http://mekhosting.com/downloads/builds/'
ADDON=xbmcaddon.Addon(id='plugin.program.mekbuilds')
...
def CATEGORIES():
    link = OPEN_URL('http://mekhosting.com/downloads/builds/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("MEKBUILDS","Downloading ",'', 'Please Wait')
